defmodule OrganizeMeWeb.UserAuthTest do
  use OrganizeMeWeb.ConnCase, async: true

  alias OrganizeMe.Accounts
  alias OrganizeMeWeb.UserAuth
  import OrganizeMe.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, OrganizeMeWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      OrganizeMeWeb.Endpoint.subscribe(live_socket_id)
