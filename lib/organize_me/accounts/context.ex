defmodule OrganizeMe.Accounts do
  @moduledoc """
  ...
  alias OrganizeMe.Accounts.UserNotifier
  ...
  If the token matches, the user email is updated and the
  token is deleted. The `confirmed_at` date will also be
  ...
  @doc """
  Emulates that the e-mail will change without actually
